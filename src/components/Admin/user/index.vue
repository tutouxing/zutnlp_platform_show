    ...
    <div class="app-container calendar-list-container">
        ...
        <div>
            <el-table :data="list" style="width: 100%" >
                ...
                <el-table-column label="序号" width="150" v-if="show"><template scope="scope" ><span>{{scope.row.id}}</span></template>
                </el-table-column>
                <el-table-column style="height: 40px;display: block" label="账号" width="150"><template scope="scope"><span>{{scope.row.userAccount}}</span></template>
                </el-table-column>
                <el-table-column label="密码" width="100"><template scope="scope"><span>{{scope.row.password}}</span></template>
                </el-table-column>
                <el-table-column width="100" label="用户名"><template scope="scope"><span>{{scope.row.username}}</span></template>
                </el-table-column>
                <el-table-column width="50" label="性别"><template scope="scope"><span>{{scope.row.gender}}</span></template></el-table-column>
                <el-table-column width="180" label="邮箱"><template scope="scope"><span>{{scope.row.email}}</span></template></el-table-column>
                <el-table-column label="最近更新时间" width="180"><template scope="scope"><span>{{scope.row.dateCreated}}</span></template>
                </el-table-column>
...
<script>
    import {page,addObj,getObj,delObj,putObj,getName}from '../../../api/admin/user/index.js'
    export default {
        name: "index",
        data() {
