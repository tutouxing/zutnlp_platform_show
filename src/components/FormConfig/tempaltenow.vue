        ...
        methods: {
          ...
          console.log("输出所有函数调用完成的表数组长度:"+that.TableMsgs.TableNames.length);
            ...
            DeleteRow(index, rows,gettablename,id) {
                ...
                let url="http://127.0.0.1:8848/"+gettablename+"/deleteById";
                this.$axios(
                    {
                        method:'post',
                        url,
            ...
            UpDataMsg(getlength,gettablename,id) {
                ...
                {
                    let url="http://127.0.0.1:8848/"+gettablename+"/updataById";
                    let obj=that.posts;
                    this.$set(obj,"id",id);
...
/*                console.log("that.Addinfo长度:"+  that.Addinfo.length);*/
            ...
            getmsg(){
                ...
                {
                    let url = "http://127.0.0.1:8848/"+this.TableMsgs.TableNames[i].name+"/list";
                    that.$axios.get(url, {}).then(function (response) {
