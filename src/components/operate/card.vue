  ...
  <el-card>
    <el-row>
      ...
      <el-col :span="2" style="text-align: right">
        <el-button @click="reviewAllResponse()">查看本文全部评论</el-button>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      ...
      <el-col :span="2" :offset="8">
        <el-button @click="passCom(content_data.id)">审核通过</el-button>
      </el-col>
      <el-col :span="2">
    ...
    export default {
        ...
        methods: {
            passCom(content_id) {//审核通过  首评状态改为1（-1不通过 0等待审核）
                // this.content_data.comments[0] = 1;
                this.$message({
                    showClose: true,
                    message: '修改成功',
                    type: 'success'
            ...
            refuseCom(content_id) {//审核不通过  首评状态改为-1（1通过 0等待审核）
                // this.content_data.comments[0] = -1;
                this.$message({
                    showClose: true,
                    message: '修改成功',
