        ...
        <el-row>
            <el-col style="span: 24">
                <el-table size="mini" :data="master_user.data" border style="width: 100%" highlight-current-row>
                    ...
                    <el-table-column v-for="(v,i) in master_user.columns" :prop="v.field" :label="v.title" :width="v.width" @change="changeColumn(v,i)">
        ...
        methods: {
            ...
            pwdChange(row, index, cg) {
                ...
                if (row.isSet) {
                    ...
                    //项目是模拟请求操作  自己修改下
                    (function () {
                        let data = JSON.parse(JSON.stringify(vm.master_user.sel));
                    ...
                    vm.master_user.sel = JSON.parse(JSON.stringify(row));
                    row.isSet = true;
                }
            },
