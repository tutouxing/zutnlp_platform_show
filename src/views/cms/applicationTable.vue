...
export default {
  ...
  created () {
    getChannelById('6').then(response => {
      ...
      tableData: [
        {
          ...
          status: '审核通过',
          title: '顶' + '[新闻] 黄金接连下跌难道又等大妈来托盘'
        },
        {
          id: 1,
          title: '[新闻] 楼市调控应跳出周期性怪圈',
          type: '普通',
          rank: 10,
          publisher: 'admin',
          count: 6727,
          ...
          id: 3,
          title: ' [新闻] 电信诈骗多发产生“蝴蝶效应”虚拟运营商融资受波及',
          type: '图文',
          top: 7,
          publisher: 'admin',
          count: 6655,
          ...
          id: 4,
          title: ' [新闻] 四川理塘县发生4.9级地震 震源深度19千米',
          type: '图文',
          top: 8,
          publisher: 'admin',
          count: 3456,
