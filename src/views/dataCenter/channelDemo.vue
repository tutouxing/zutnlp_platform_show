    ...
    <el-card>
        <el-col>
            ...
            <el-row>
                ...
                <div id="channel3_dv" style="width: 650px; height: 580px"></div>
                </el-card>
                </el-col>
                <el-col span="12">
                    <el-card :body-style="{ padding: '40px' }">
                        <div id="channel4_dv" style="width: 650px; height: 580px"></div>
                    </el-card>
                </el-col>
            </el-row>
        </el-col>
  ...
  export default {
    ...
    methods: {
      drawLine () {
        ...
        for (let i = 0;i<this.$store.state.channel.length;i++) {
          this.dataSet1.xAxis.data.push(this.$store.state.channel[i].chName);
          this.dataSet1.series[0].data.push(this.$store.state.channel[i].enName);
        }
        ...
        let myChart3 = echarts.init(document.getElementById('channel3_dv'));
        myChart3.setOption(this.dataSet1);
      },
    }
  }
</script>
