<template>
  <div class="hello">
    ...
    <div>
      ...
      <iframe src="http://10.36.20.12:8846/zutnlp_cv_web2.0/web3.0/dist/" style="frameBorder:0; width:100%; scrolling:yes; height:1000px"></iframe>
    </div>
    <!--<component :is=""/>-->
  </div>
</template>
...
<script>
    import TreeGrid from '_c/TableTree/withButton.vue'
    ...
    export default {
        ...
        methods:{
            ...
            getRequest(index,row){
                //调用对应的组件展示到服务列表下面
                this.$router.push("http://10.36.20.12:8845/")
            },
        },
        created(){
            // this.getAllServices();
